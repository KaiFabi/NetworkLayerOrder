...
def parse_tensorboard_event_files(runs_dir: str, outputs_dir: str):
    """
    """
    if os.path.isdir(runs_dir):
        event_paths = glob.glob(os.path.join(runs_dir, "*", "event*"))
    elif os.path.isfile(runs_dir):
        event_paths = [runs_dir]
    else:
        raise ValueError(f"{runs_dir} has to be a file or directory.")
    ...
    if event_paths:
        ...
        for event_path in event_paths:
            ...
            out_file = os.path.join(outputs_dir, file_name)
